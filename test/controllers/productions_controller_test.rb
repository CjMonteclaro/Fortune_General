...
class ProductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post productions_url, params: { production: { branch: @production.branch, intermediary: @production.intermediary, intm_no: @production.intm_no } }
    end
  ...
  test "should update production" do
    patch production_url(@production), params: { production: { branch: @production.branch, intermediary: @production.intermediary, intm_no: @production.intm_no } }
